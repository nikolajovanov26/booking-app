        ...
        <div class="flex h-48 w-full space-x-6">
            ...
            <div class="w-1/3 bg-white rounded-xl shadow-2xl overflow-hidden">
                <div class="w-full h-full flex flex-col items-stretch space-y-5">
                    ...
                    <div class="flex justify-end items-center px-10 bg-gray-100 h-2/5">
                        <a href="{{ route('dashboard.properties.index') }}" class="text-lg py-2 text-blue-600 font-semibold hover:text-gray-800 transition"
                        >View Properties</a>
                    </div>
                </div>
            </div>
            <div class="w-1/3 bg-white rounded-xl shadow-2xl overflow-hidden">
                <div class="w-full h-full flex flex-col items-stretch space-y-5">
                    ...
                    <div class="flex justify-end items-center px-10 bg-gray-100 h-2/5">
                        <a href="{{ route('dashboard.reviews') }}" class="text-lg py-2 text-blue-600 font-semibold hover:text-gray-800 transition"
                        >View Reviews</a>
                    </div>
                </div>
            </div>
