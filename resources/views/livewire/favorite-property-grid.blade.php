<div x-data="{removeFavoriteModal: false}">
    <div class="grid grid-cols-3 gap-6 items-start ">
        <div class="bg-white shadow hover:shadow-xl transition p-4 mb-3 rounded-lg space-y-4">
            ...
            <div class="flex justify-between items-start">
                <div>
                    <a href="#"
                       class="font-semibold text-lg text-blue-800 hover:text-blue-900 hover:underline transition line-clamp-1">Property
                        Name</a>
                ...
                <div class="flex items-center">
                    <button
                        ...
                        @click='removeFavoriteModal = true' class="text-red-600">
            ...
            <div class="flex items-center space-x-5">
                <button
                    class="w-full py-2 rounded font-semibold text-lg border-2 border-blue-600 text-blue-600 transition hover:bg-blue-100">
                    View Property
                </button>
                <button
    ...
    <div
        ...
        x-cloak
        class="fixed inset-0 backdrop-blur-sm bg-gray-800/20">
        <div class="flex items-center justify-center w-full h-full">
            <div @keydown.esc="removeFavoriteModal = false"
                ...
                <p class="text-xl font-semibold">Are you sure you want to remove 'Property Name' from favorites?</p>
                <div class="flex justify-end items-center space-x-6">
                    <button @click="removeFavoriteModal = false"
                        class="text-red-600 hover:text-red-800 transition hover:underline">Cancel</button>
                    <button @click="removeFavoriteModal = false"
                        class="px-4 py-2 rounded text-white bg-red-600 hover:bg-red-800 transition">Delete</button>
                </div>
            </div>
        </div>
    </div>
