<div>
    <div x-data="{ show: @entangle('show')} ">
        ...
        <div x-show="show" x-transition:enter x-cloak
            ...
            <div x-show="show"
                 class="w-3/5 flex ">
                <div x-data='{dropdown: false, selected: "{{ $value ?? 'Select your country' }}"}'
                    ...
                    <div @click.outside="dropdown = false" class="relative">
                        <button @click="dropdown = !dropdown" type="button" aria-haspopup="listbox" aria-expanded="true"
                                ...
                                <span class="flex items-center">
                                    <span class="block truncate text-gray-500" x-text="selected"
                                          x-show="selected === 'Select your country'"></span>
                                    <span class="block mt-0.5" x-text="selected" x-show="selected !== 'Select your country'"></span>
                                </span>
                        </button>
                        ...
                        <ul x-show="dropdown" x-transition.origin.top x-cloak
                            ...
                            @foreach($countries as $country)
                                <li @click='selected = "{{ $country->label }}"; dropdown = false'
                ...
                <button class="bg-blue-600 rounded ml-4 py-1.5 px-4 text-white">Update</button>
