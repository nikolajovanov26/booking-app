            ...
            <table class="text-left w-full">
                <div class="px-6 py-4 flex items-center justify-between bg-blue-grad-dark">
                    <div class="flex items-center">
                        ...
                        <input wire:model.defer="search"
                               ...
                               type="text" name="search" placeholder="Filter Payment Methods"
                    ...
                    <div class="flex items-center">
                        <button @click="showCreateModal = true" @keydown.esc="showCreateModal = false"
                                class="bg-white hover:text-white hover:bg-blue-grad-light transition py-3 px-6 text-blue-grad-dark font-semibold text-lg rounded">Add Payment Method</button>
                    </div>
                </div>
                ...
                @foreach($paymentMethods as $payment)
                    <tr class="hover:bg-gray-100 transition">
                        ...
                        <td class="p-4 capitalize">{{ $payment->label }}</td>
                        <td class="p-4 text-center">{{ $payment->properties()->count() }}</td>
