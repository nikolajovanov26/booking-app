        ...
        <div class="bg-white shadow-xl rounded-xl overflow-hidden">
            <table class="text-left w-full">
                ...
                <tr class="hover:bg-gray-100 transition">
                    ...
                    <td class="px-6 py-4">
                        <span class="bg-green-600 tracking-wide text-white px-4 pt-0.5 pb-1 rounded-xl">paid</span>
                    </td>
                    ...
                    <td class="flex items-center justify-end px-6 py-4 text-right space-x-4">
                        <a href="{{ route('properties.show') }}" class="text-blue-600 hover:text-blue-900 transition">Preview</a>
                        <button class="bg-red-700 hover:bg-red-900 transition text-white rounded px-3 py-2">Cancel</button>
                    </td>
                </tr>
                </tbody>
            </table>
