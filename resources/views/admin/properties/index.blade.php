                    ...
                    @foreach($properties as $property)
                        <tr class="hover:bg-gray-100 transition">
                            ...
                            <td class="flex items-center justify-end p-4 text-right space-x-4">
                                ...
                                <a href="{{ route('admin.properties.reviews', ['property' => $property->id]) }}" class="text-blue-600 hover:text-blue-900 transition">Reviews</a>
                                ...
                                <form method="post" action="{{ route('admin.properties.destroy', ['property' => $property->id]) }}">
                                    @csrf
                                    @method('DELETE')
